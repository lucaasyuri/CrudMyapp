            ...
            <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                ...
                <table class="table-auto w-full text-left whitespace-no-wrap">
                    ...
                    <tbody class="divide-y">
                        ...
                        <!-- $loop: variável interna do foreach -->
                            ...
                            <!-- $loop->even: apenas as linhas pares são cinzas -->
                                ...
                                <td class="px-4 py-3 text-sm text-right space-x-3 text-gray-900">
                                    ...
                                    <!-- $product->id: passando o id do produto como parâmetro -->

                                    <form action="{{ route('admin.product.destroy', $product->id) }}" method="POST">

                                        @csrf <!-- csrf: diretiva de segurança do laravel -->
                                        @method('delete') <!-- forçando método PUT (update) -->
